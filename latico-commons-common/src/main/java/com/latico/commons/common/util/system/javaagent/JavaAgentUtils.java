package com.latico.commons.common.util.system.javaagent;

import com.latico.commons.common.util.system.javaagent.agent.JavaAgent;
 ...
 * @since     jdk版本：jdk1.6
 */
public final class JavaAgentUtils {

	/** 私有化构造函数 */
	protected JavaAgentUtils() {}
	...
	public static long sizeOf(Object o) {
		if (JavaAgent.getInstn() == null) {
			System.err.println("无法访问 instrumentation 环境: "
					+ "请检查启动脚本是否包含参数 [\"-javaagent\"].");
			return -1;
		}
		return JavaAgent.getInstn().getObjectSize(o);
	}
