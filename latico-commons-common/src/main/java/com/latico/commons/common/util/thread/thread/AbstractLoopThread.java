 ...
 * 使用示例:
 * 
 * 	DemoThread dt = new DemoThread();	// DemoThread 继承 AbstractLoopThread
 *  DemoThread 需实现3个方法:
...
public abstract class AbstractLoopThread extends Thread {
	...
	/** 日志器 */
	private final static Logger log = LoggerFactory.getLogger(AbstractLoopThread.class);
	 ...
	 * @param name 线程名称
	 */
	protected AbstractLoopThread(final String name) {
		super(name);
		this.hasRun = false;
		this.isStop = true;
	...
	public final synchronized void start() {
		System.err.println(AbstractLoopThread.class.getName() +
