...
public class Template {
	...
	public void read(String templateFileName, String charset) {
		...
		try {
			orgContent = IOUtils.resourceToStringByClass(Template.class, templateFileName);
	...
	public String getContent(String charset) {
		...
		try {
			...
			System.err.println("警告:[" + charset + "]编码异常,自动替换为默认编码[" + 
					DEFAULT_CHARSET + "]");
		}
	...
	public static void main(String[] args) {
		InputStream is = Template.class.
				getResourceAsStream("bean_template");
