...
public class RandomUtils extends org.apache.commons.lang3.RandomUtils {
	...
	public static String[] genChineseName() {
		...
		if(nameType <= SINGLE_SURNAME_1WORD) {
			chineseName[0] = StringUtils.join(singleSurname1[0], "-", word1[0]);
			chineseName[1] = StringUtils.join(singleSurname1[1], word1[1]);
			
		} else if(nameType <= TWOSYLLABLE_SURNAME_1WORD) {
			chineseName[0] = StringUtils.join(singleSurname1[0], singleSurname2[0], "-", word1[0]);
			chineseName[1] = StringUtils.join(singleSurname1[1], singleSurname2[1], word1[1]);
			
		} else if(nameType <= COMPOUND_SURNAME_1WORD) {
			chineseName[0] = StringUtils.join(compoundSurname[0], "-", word1[0]);
			chineseName[1] = StringUtils.join(compoundSurname[1], word1[1]);
			
		} else if(nameType <= SINGLE_SURNAME_2WORD) {
			chineseName[0] = StringUtils.join(singleSurname1[0], "-", word1[0], word2[0]);
			chineseName[1] = StringUtils.join(singleSurname1[1], word1[1], word2[1]);
			
		} else if(nameType <= TWOSYLLABLE_SURNAME_2WORD) {
			chineseName[0] = StringUtils.join(singleSurname1[0], singleSurname2[0], "-", word1[0], word2[0]);
			chineseName[1] = StringUtils.join(singleSurname1[1], singleSurname2[1], word1[1], word2[1]);
			
		} else if(nameType <= COMPOUND_SURNAME_2WORD) {
			chineseName[0] = StringUtils.join(compoundSurname[0], "-", word1[0], word2[0]);
			chineseName[1] = StringUtils.join(compoundSurname[1], word1[1], word2[1]);
		}
	...
	public static boolean hit(int percent) {
		percent = NumberUtils.limitRange(percent, 0, 100);
		int random = genInt(1, 100);
