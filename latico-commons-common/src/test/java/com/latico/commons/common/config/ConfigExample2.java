 ...
 * @version: 1.0
 */
public class ConfigExample2 extends AbstractConfig {
    /**
     * instance 单例实例
     */
    private static volatile ConfigExample2 instance = null;
     ...
     * @return
     */
    public static ConfigExample2 getInstance() {
        if (instance == null) {
            synchronized (ConfigExample2.class) {
                if (instance == null) {
                    instance = new ConfigExample2();
                }
            }
        }
        return instance;
