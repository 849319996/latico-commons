...
public enum TerminalTypeEnum {
	...
	VT220("VT220", "VT220"),
	VTNT("VTNT", "VTNT"),
	VTANSI("VTANSI", "VTANSI"),
	LINUX("LINUX", "LINUX"),
	;
	
	private final static Map<String, TerminalTypeEnum> nameValue = new HashMap<String, TerminalTypeEnum>();
	static{
	...
	public static TerminalTypeEnum getEnumByName(String name){
		if(name != null){
