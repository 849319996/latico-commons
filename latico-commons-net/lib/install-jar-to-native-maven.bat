...
@echo on
set jarAbsoluteDir=C:\project\latico\latico-commons\latico-commons-net\lib

@rem ====================
set jarFileName=AdventNetSnmp-4.0.4.jar
set jarGroupId=com.adventnet.snmp
set jarArtifactId=AdventNetSnmp
set jarVersion=4.0.4
...
set jarFileName=AdventNetSnmp-4.0.4.jar
set jarGroupId=com.adventnet.snmp
set jarArtifactId=AdventNetLogging
set jarVersion=4.0.4
call mvn install:install-file -Dfile=%jarAbsoluteDir%/%jarFileName% -DgroupId=%jarGroupId% -DartifactId=%jarArtifactId% -Dversion=%jarVersion% -Dpackaging=jar
