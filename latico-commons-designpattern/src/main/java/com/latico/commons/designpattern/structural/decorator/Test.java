package com.latico.commons.designpattern.structural.decorator;

import com.latico.commons.designpattern.structural.decorator.decorator.impl.DoHairPersonBehaviorDecoratorImpl;
import com.latico.commons.designpattern.structural.decorator.decorator.impl.DressPersonBehaviorDecoratorImpl;
import com.latico.commons.designpattern.structural.decorator.decorator.impl.HaveShowerPersonBehaviorDecoratorImpl;
import com.latico.commons.designpattern.structural.decorator.personbehavior.PersonBehavior;
import com.latico.commons.designpattern.structural.decorator.personbehavior.impl.ManPersonBehaviorImpl;
import com.latico.commons.designpattern.structural.decorator.personbehavior.impl.WomanPersonBehaviorImpl;
