...
public class OmcServerChannelInboundHandlerImpl extends SimpleChannelInboundHandler<OmcProtocol> {

    private static final Logger LOG = LoggerFactory.getLogger(OmcServerChannelInboundHandlerImpl.class);
    private ChannelGroup channelGroup;
    private NettyServer nettyServer;

    public OmcServerChannelInboundHandlerImpl(NettyServer nettyServer) {
    ...
    @Override
    protected void channelRead0(ChannelHandlerContext ctx, OmcProtocol msg) {
