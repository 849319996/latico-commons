...
public class OmcClientChannelInboundHandler extends SimpleChannelInboundHandler<OmcProtocol> {

    private static final Logger LOG = LoggerFactory.getLogger(OmcClientChannelInboundHandler.class);
    private NettyClient nettyClient;

    public OmcClientChannelInboundHandler(NettyClient nettyClient){
