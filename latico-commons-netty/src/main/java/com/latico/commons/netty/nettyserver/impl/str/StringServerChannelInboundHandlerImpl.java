...
public class StringServerChannelInboundHandlerImpl extends SimpleChannelInboundHandler<String> {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(StringServerChannelInboundHandlerImpl.class);
    private ChannelGroup channelGroup;
    private NettyServer nettyServer;

    public StringServerChannelInboundHandlerImpl(NettyServer nettyServer) {
