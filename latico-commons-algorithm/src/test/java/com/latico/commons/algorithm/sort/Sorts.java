...
public class Sorts {
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	private static void quickSort(List<Comparable> obj, final int left, final int right,
			boolean asc) {
		int i, j;
	 ...
	 * list1.add(&quot;aaaa&quot;);
	 * list1.add(&quot;bb&quot;);
	 * CollectionUtils.quickSort(list1);
	 * 
	 * List list2 = new ArrayList();
	 * list2.add(&quot;cc&quot;);
	 * list2.add(&quot;dd&quot;);
	 * list2.add(&quot;zz&quot;);
	 * CollectionUtils.quickSort(list2);
	 * 
	 * List listAll = new ArrayList();
	 * listAll.add(list1);
	 * listAll.add(list2);
	 * 
	 * List sortList = CollectionUtils.listMerge(listAll);
	 ...
	 * listAll.add(list2);
	 * 
	 * List sortList = CollectionUtils.listMerge(listAll,false);
	 * System.out.println(sortList);
	 * </pre>
	 * 
	 * @param objs
	 ...
	 * <pre>
	 * 二分查找法
	 * 在进行此调用之前，必须根据列表元素的自然顺序对列表进行升序排序(通过 sort1(List) 方法).
